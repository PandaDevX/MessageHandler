...
public class CommandBannedWordsInventory implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        MenuClick.bannedWords = new BannedWords(user);
        MenuClick.bannedWords.setup(1);
        MenuClick.bannedWords.open();
        return false;
    }
}
